...
public class WeatherApp
{
    public static JSONObject getWeatherData(String locationName)
        {
            ...
            try
            {
                ...
                JSONArray wheatherCode = (JSONArray) hourly.get("weather_code");
                String wheatherCondition = convertWeatherCode((long) wheatherCode.get(index));
                ...
                weatherData.put("weather_Condition",wheatherCondition);
  ...
  public static int findCurrentIndexTime(JSONArray timeList)
  {
   ...
   private static String getCurrentTime()
   {
       ...
       String formattedDataTime = currentDataTime.format(formatter);
   ...
   private static String convertWeatherCode(long weathercode)
   {
       ...
       if(weathercode == 0L)
       {
           wheatherCondition="Clear";
       } else if (weathercode >0L && weathercode <=3L) {
           wheatherCondition="Cloudy";
       } else if ((weathercode >=51L && weathercode <=67L ) || (weathercode>=80L && weathercode <=99L) ){
            wheatherCondition = "Rain";
       }
       else if (weathercode >=71L && weathercode <=77L ) {
           wheatherCondition = "Snow";
       }
